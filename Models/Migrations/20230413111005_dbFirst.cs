        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaintingCategory = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Paintings_FundRaisers_FundRaiserId",
                        column: x => x.FundRaiserId,
                        principalTable: "FundRaisers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Paintings_Organizers_OrganizerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Artists_Paintings", x => new { x.ArtistId, x.PaintingId });
                    table.ForeignKey(
                        name: "FK_Artists_Paintings_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Artists_Paintings_Paintings_PaintingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Artists_Paintings_PaintingId",
                table: "Artists_Paintings",
                column: "PaintingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Paintings_FundRaiserId",
                table: "Paintings",
                column: "FundRaiserId");

            migrationBuilder.CreateIndex(
                name: "IX_Paintings_OrganizerId",
                table: "Paintings",
                column: "OrganizerId");
